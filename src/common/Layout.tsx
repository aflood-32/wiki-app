    ...
    <header className="header">
      ...
      <div className="wrap wrap_fluid">
        <div className="header__block">
          ...
          <button type="button" className="header__sign-in hidden visible-md">sign in</button>
        </div>
      </div>
    </header>
          ...
          <div className="footer__section footer__section_lg-md">
            <div className="footer__links hidden visible-md">
              <ul>
                ...
                <li><span>or</span></li>
                <li><button type="button">Choose your language</button></li>
                <li><button type="button">mobile view</button></li>
                <li><a href="/">classic wikipedia</a></li>
              </ul>
            </div>
          </div>
          <div className="footer__section footer__section_lg-xs">
            <div className="footer__history">
              <ul>
                ...
                <li><a href="/">William 3</a></li>
                <li><a href="/">Dj Beat</a></li>
                <li><a href="/">Dmytro Gordon</a></li>
              </ul>
            </div>
          </div>
        </div>
